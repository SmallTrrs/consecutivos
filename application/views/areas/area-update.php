            ...
            <div class="offset-md-1 col-md-7 bg-light border rounded-lg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 bg-white m-4 border rounded p-3">
                        ...
                        <!-- formulario  -->
                        <?php  $hidden = ['idarea' => $area->idarea]; ?>
                        <?= form_open( 'areas/update_db','', $hidden ); ?>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="descripcion" maxlength="50"
                                        id="descripcion"
                                        value="<?= $session->flashdata('descripcion') === null ? $area->descripcion : $session->flashdata('descripcion'); ?>"
                                        autocomplete="off">
                        ...
                        <div class="row pl-3 my-2">
                            <div class="col-md-10 ">
                                <button type="submit" class="btn btn-sm btn-dark px-3"> <i class="fa fa-save pr-2"></i>
                                    Actualizar</button>
                                <a href="<?=base_url('areas');?>" class="btn btn-sm btn-primary px-3 ml-3"> <i
