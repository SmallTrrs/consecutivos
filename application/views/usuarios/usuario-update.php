            ...
            <div class="offset-md-1 col-md-7 bg-light border rounded-lg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 bg-white m-4 border rounded p-3">
                        ...
                        <!-- formulario  -->
                        <?php $hidden = ['idusuario' => $usuario->idusuario, 'password'=> 'protegido', 'passconf' => 'protegido'] ; ?>
                        <?= form_open('usuarios/update_db','', $hidden ); ?>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="nombre" maxlength="80"
                                        id="nombre"
                                        value="<?= $session->flashdata('nombre') === null ? $usuario->nombre : $session->flashdata('nombre'); ?>"
                                        autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="usuario"
                                        ...
                                        value="<?= $session->flashdata('usuario') === null ? $usuario->usuario : $session->flashdata('usuario'); ?>"
